...
public abstract class Notation implements Serializable {
  ...
  /*------------------------------------------------------------------*/
  /** Create a notation.
   *  @since  2023.07.31 (Christian Borgelt) */
  /*------------------------------------------------------------------*/
   ...
   *  once (and thus needs no label) -n, n &gt; 0, means that it has
   *  been visited n+1 times and therefore needs n labels (for n
   *  "backward connections"). The procedure is a depth-first search
   *  and assumes that all nodes have been marked with the value 1
   *  before.</p>
