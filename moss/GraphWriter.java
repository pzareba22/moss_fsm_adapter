 ...
 *  @since  2007.02.24 */
/*--------------------------------------------------------------------*/
public abstract class GraphWriter extends TableWriter
  ...
  public static final int DIRECTED = GraphReader.DIRECTED;
  /** write mode mask: table input formats */
  public static final int FMTMASK  = GraphReader.FMTMASK;
  ...
  {                             /* --- create a graph writer */
    if (format.equalsIgnoreCase("smiles"))
      return new LineWriter(writer, mode, new SMILES());
    if (format.equalsIgnoreCase("smi"))
      return new LineWriter(writer, mode, new SMILES());
    if (format.equalsIgnoreCase("sln"))
      return new LineWriter(writer, mode, new SLN());
    ...
    if (format.equalsIgnoreCase("linog"))
      return new LineWriter(writer, mode, new LiNoG());
