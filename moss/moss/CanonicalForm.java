/*----------------------------------------------------------------------
  ...
  History : 2002.03.11 file created as file submol.java
            ...
            2021.10.05 optional treatment of edges as directed added
----------------------------------------------------------------------*/
package moss;
...
public abstract class CanonicalForm implements Serializable {
  ...
  {                             /* -- create a canonical form object */
    this.mode  = EDGE|SIMPLE;   /* initialize the extension variables */
    this.dir   = false;         /* simple, undirected edge extensions */
   ...
   *  @return whether there may be extensions
   ...
   *  @param  frag the fragment to extend
   *  @return whether they may be extensions
  ...
  {                             /* --- create the next extension */
    ...
    Node[] o, b, n;             /* to traverse/access the nodes */
  ...
  {                             /* --- create next extended fragment */
    ...
    while (true) {              /* try to find another extension */
      ...
      if (this.dst < g.nodecnt){/* if the new edge closes a ring */
        ...
        if ((this.mode & SIMPLE) != 0) {   /* if simple graphs */
        ...
        } }                     /* (always if graphs are not simple) */
   ...
   *  @return thether a prefix is a ring key
   ...
   *  @return the class of the root node
