...
public class Recoder implements Serializable {
  ...
  {                             /* --- add a type */
    ...
    RcType   t;                 /* new type object */
    RcType[] v;                 /* reallocation buffer */
   ...
   *  @return the frequency of the type
   ...
   *  for such a type.</p>
   *  @param  freq  whether to trim (also) by frequency
   ...
   *  @return whether the type is excluded
   *  @see    #exclude(int)
   *  @since  2006.08.10 (Christian Borgelt) */
  /*------------------------------------------------------------------*/
   ...
   *  @param  code the code of the type to check
   *  @return whether the code has maximal frequency
   *  @see    #maximize(int)
   *  @since  2006.08.10 (Christian Borgelt) */
  /*------------------------------------------------------------------*/
